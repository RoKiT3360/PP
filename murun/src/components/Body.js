    ...
    <div className="w-full flex flex-col">
      <div className="w-full h-[60vh] flex justify-center items-center bg-no-repeat bg-cover bg-[url('https://www.freecodecamp.org/news/content/images/2021/06/w-qjCHPZbeXCQ-unsplash.jpg')]">
        <div className="w-[70%] h-full flex flex-col justify-center gap-3">
          <p className="text-2xl sm:text-4xl text-white">Your account is in your hands.</p>
          <p className="flex flex-wrap w-[300px] sm:w-[500px] text-white">
          ...
          <button className="w-[300px] sm:w-[350px] py-3 px-3 bg-blue-600 rounded-full">
            Sign Up for Free
          </button>
        </div>
      </div>
      <div className="w-full h-[15vh] bg-zinc-800 flex justify-center items-center">
        <div className="w-[100%] sm:w-[70%] h-full flex">
          <div className="flex items-center gap-3 w-[40%]">
            <div className="w-4 h-4 sm:w-12 sm:h-12 rounded-full border border-white-1 flex justify-center items-center">
              1
            </div>
            <p className="flex flex-wrap text-[10px] w-[100px] sm:text-sm sm:w-[350px]">
      ...
      <div className="w-full h-[40vh] bg-white flex justify-center items-center">
        <div className="w-[60%] flex justify-center items-center flex-col gap-2">
          <p className="text-2xl sm:text-4xl text-black">Accepted all over the place.</p>
          <p className="flex flex-wrap text-black text-center text-xs sm:text-sm">
      ...
      <div className="w-full h-[40vh] bg-blue-900 flex justify-center items-center">
        <p className="sm:text-4xl text-2xl w-[60%] text-center">
      ...
      <div className="w-full h-[50vh] bg-orange-100 flex justify-center sm:justify-end items-center">
        <div className="w-[80%] sm:w-[50%] h-full flex flex-col justify-center gap-3">
      ...
      <div className="w-full h-[40vh] bg-zinc-800 flex justify-center items-center">
        <div className="w-[80%] sm:w-[40%] h-full flex flex-col text-center justify-center gap-3">
          <p className="sm:text-5xl text-2xl font-thin">No hidden costs, no surprises.</p>
